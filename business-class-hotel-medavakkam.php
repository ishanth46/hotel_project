...
<!-- calender  -->
<section
    class="max-w-6xl mx-auto shadow-md  relative  relative top-0 md:top-[-80px] bg-white p-4 mt-0 md:mt-8 mb-30px md:mb-0">
    <h3 class="block lg:hidden text-[#004875] text-xl  md:text-3xl  font-lora leading-[1.5] text-center pb-3">Book Your
        Rooms</h3>
...
<section
    ...
    <div class="w-[350px] md:w-[750px] py-4 md:py-0 pr-0 md:pr-8">
        <div>
            <h3 class="text-[#004875] text-base  md:text-xl  font-lora leading-[1.5] p-2 uppercase">Deluxe Double Room
            </h3>
...
<section
    ...
    <div class="w-[350px] md:w-[750px] py-4 md:py-0 pr-0 md:pr-8 mx-auto">
        <div>
            <h3 class="text-[#004875] text-base  md:text-xl  font-lora leading-[1.5] p-2 uppercase">Deluxe Twin Room
            </h3>
